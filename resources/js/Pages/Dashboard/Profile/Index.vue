                    ...
                    <v-row class="pb-2">
                        <v-col cols="12" md="7">
                            <v-row>
                                <v-col cols="12" md="4" class="text-center">
                                    <div class="avatar-wrapper">
                                        <v-avatar
                                            size="150"
                                            class="mb-3 mt-n12 profile-avatar"
                                        >
                                            <v-img
                                                v-if="form.image_url"
                                                :src="form.image_url"
                                        ...
                                        >
                                            ...
                                            >
                                            <span
                                                class="ml-1 text-white text-caption"
                                                >Upload</span
                                            >
                                            <input
                                                type="file"
                                    ...
                                    <v-row class="mt-2">
                                        <v-col cols="12">
                                            ...
                                            >
                                                ...
                                                >
                                                    <label
                                                        class="mb-1 text-subtitle-2 text-grey-darken-2"
                                                        >Gender</label
                                                    >
                                                    <v-radio
                                                        label="Male"
                            ...
                            <v-row class="mt-3">
                                <v-col cols="12">
                                    <v-btn
                                        style="background-color: #209ab9"
                                        class="px-6 text-white rounded-lg text-capitalize text-subtitle-1"
                                        :disabled="
                                    ...
                                    <v-table class="rounded-lg">
                                        ...
                                        <tbody v-else>
                                            <tr>
                                                <td
                                                    colspan="5"
                                                    class="py-4 text-center text-grey-darken-1"
                                                >
                                                    <v-icon
                                                        class="mb-2"
                                                        size="large"
